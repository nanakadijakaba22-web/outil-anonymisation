            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">
                  Verifiez la classification des colonnes ci-dessous. Vous pouvez ajuster le type de sensibilite
                  et la categorie si necessaire. Cliquez sur "Configurer l'anonymisation" pour voir les techniques
                  qui seront appliquees a chaque colonne avant de lancer l'anonymisation.
                </p>
              </div>
            </div>
          </div>
